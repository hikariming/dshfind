...
|---|---|---|
| Service Definition | `shell/` | Defines `ctx.shell`: the capability contract for executing commands |
| Service Provider | `bash-local/`, `bash-sandbox/`, `pwsh-local/` | Each implements an executor |
| Consumer | `tool-bash/`, `tool-pwsh/`, `hooks-claude-code/`, `hooks-codex/` | Model-facing shell tools and hook bridges |
