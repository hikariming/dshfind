...
What exactly is a "temporary plugin"? The README spells out its lifecycle (source: `packages/self-modification/tool-cordis/README.zh.md`):
...
One point that must be made clear: this toolset is **explicitly opt-in**, and enabling it deserves the same caution as granting the bash tool. The reason is written in the "trust stance" section (source: `packages/self-modification/tool-cordis/README.zh.md`):
