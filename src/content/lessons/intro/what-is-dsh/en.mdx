...
| **dsh (the tool)** | The CLI built on the SDK: `dsh web` opens the Web UI, `dsh run "task"` runs tasks | A computer with the OS installed |
...
| Command line | `dsh run "summarize this workspace"` | Run a task once, print the answer, then exit |
